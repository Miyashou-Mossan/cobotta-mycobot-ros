...
# Use only the six COBOTTA arm joints in start_state_.
# The legacy execution code overwrites these values using
# move_group.getCurrentJointValues(), which normally returns six arm values.
...
def validate_and_convert_joint_trajectory(root: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # The legacy loader later overwrites these six values with the actual
    # COBOTTA arm state immediately before execute().
