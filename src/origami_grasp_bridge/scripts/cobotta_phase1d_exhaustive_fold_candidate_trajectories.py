...
def candidate_topic(
    ...
    return (
        "/origami/"
        "cobotta_phase1d_exhaustive_fold_candidate_trajectory/"
        "p0_{}_c{}_{}"
        .format(
            p0_index,
            candidate_index,
...
def main():
    rospy.init_node(
        "cobotta_phase1d_exhaustive_fold_candidate_trajectories"
    )

    print(
        "===== PHASE1-D EXHAUSTIVE FOLD CANDIDATE "
